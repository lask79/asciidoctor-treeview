...
const IconRegistry = require('./icons/icon-registry')
const iconRegistry = new IconRegistry()
const TreeViewRenderer = require('./renderer/treeview-renderer')
const treeViewRenderer = new TreeViewRenderer(iconRegistry)
...
function register (registry, context) {
  if (context?.playbook) {
    registerAntoraExtension(registry, context, iconRegistry, cssGenerator)
    return
  }
